...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyACAZ4QndY7bl5SINQgjxsMOKqr51wyMBI"></script>
...
var officeLocations = [
<?php
$data = file_get_contents('http://localhost/webgis/ambildata.php');
                $no=1;
